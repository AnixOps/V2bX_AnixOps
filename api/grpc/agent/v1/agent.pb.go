...
const file_api_grpc_agent_v1_agent_proto_rawDesc = "" +
	...
	"\rControlStream\x12\x1d.anix.agent.v1.AgentToControl\x1a\x1d.anix.agent.v1.ControlToAgent(\x010\x01B>Z<github.com/AnixOps/anix-agent/v3/api/grpc/agent/v1;agentv1pbb\x06proto3"
