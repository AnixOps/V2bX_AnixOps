...
- [x] Archive successful `v2.5.0-rc.6` GitHub Actions QUIC/WSS namespace acceptance evidence.
- [ ] Prove GOST relay+QUIC route orchestration on geographically separated domestic-entry and overseas-exit machines.
- [x] Add release-gated GitHub Actions namespace acceptance for GOST relay+WSS compatibility mode; WSS remains non-default.
- [ ] Prove WSS compatibility mode on geographically separated machines.
